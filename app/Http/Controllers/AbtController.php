...
class AbtController extends Controller
{
    ...
    public function home()
    {
        ...
        $abts = Abt::all();
        $contentString = '<a href="/~plant/plantmaker/public/detail/[place_name]"><h1 id="firstHeading" class="firstHeading">[place_name]</h1></a>'.
        '<div id="content" class="from group row">'.
